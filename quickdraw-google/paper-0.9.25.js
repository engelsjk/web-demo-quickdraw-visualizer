...
var paper = new function(t) {
        ...
        function n(t, n, i, r, a) {
            function o(s, o) {
                ...
                var l, d = "function" == typeof o,
                    _ = o,
                    f = a || d && !o.base ? o && o.get ? s in t : t[s] : null;
                a && f || (d && f && (o.base = f), d && r !== !1 && (l = s.match(/^([gs]et|is)(([A-Z])(.*))$/)) && (h[l[3].toLowerCase() + l[4]] = l[2]), _ && !d && _.get && "function" == typeof _.get && e.isPlainObject(_) || (_ = {
                    ...
                    configurable: !0
                }).configurable && (_.configurable = !0, _.enumerable = i), c(t, s, _))
            }
            var h = {};
            if (n) {
    ...
    "undefined" != typeof module && (module.exports = e), e.inject({
        ...
        statics: {
            ...
            extend: function tt() {
                var t = tt.base.apply(this, arguments),
            ...
            initialize: function nt() {
                ...
                if (!this.browser) {
                    var i = navigator.userAgent.toLowerCase(),
                        r = (/(win)/.exec(i) || /(mac)/.exec(i) || /(linux)/.exec(i) || [])[0],
                        s = t.browser = {
                            platform: r
                        };
    ...
    var a = new function() {
            ...
            return {
                ...
                solveCubic: function(e, n, u, l, c, d, _) {
                    var f, g, v, p = 0;
                    if (i(e) < o) e = n, g = u, v = l, f = 1 / 0;
                    else if (i(l) < o) g = n, v = u, f = 0;
                    else {
                        ...
                        if (f = -(n / e) / 3, S = e * f, g = S + n, v = g * f + u, w = (S + g) * f + v, y = v * f + l, x = y / e, b = s(i(x), 1 / 3), C = 0 > x ? -1 : 1, x = -w / e, b = x > 0 ? 1.3247179572 * Math.max(b, r(x)) : b, m = f - C * b, m !== f) {
                            do
                                if (f = m, S = e * f, g = S + n, v = g * f + u, w = (S + g) * f + v, y = v * f + l, m = 0 === w ? f : f - y / w / P, m === f) {
                                    f = m;
                                    break
                                }
                            while (C * m > C * f);
        ...
        v = r.extend({
            ...
            getActiveLayer: function() {
                return this._activeLayer || new w({
                    project: this
                })
            },
        ...
        m = e.extend(n, {
            ...
            setPivot: function() {
                this._pivot = h.read(arguments, 0, {
                    clone: !0,
                    readNull: !0
                }), this._position = t
            },
            ...
            _clone: function(n, i, r) {
                var s = ["_locked", "_visible", "_blendMode", "_opacity", "_clipMask", "_guide"],
                    a = this._children;
            ...
            rasterize: function(t) {
                var n = this.getStrokeBounds(),
                    ...
                    a = new l(s.subtract(r)),
                    o = Y.getCanvas(a.multiply(i)),
                    h = o.getContext("2d"),
                    u = (new f).scale(i).translate(r.negate());
            ...
            _hitTest: function(n, i) {
                function r(i, r) {
                    var s = f["get" + r]();
                    return n.subtract(s).divide(u).length <= 1 ? new S(i, _, {
                        name: e.hyphenate(r),
                        point: s
                    }) : t
                }
                ...
                var s = this._matrix,
                    ...
                    u = i._tolerancePadding = new l(O._getPenPadding(1, h.inverted())).multiply(Math.max(i.tolerance, 1e-6));
                if (n = s._inverseTransform(n), !this._children && !this.getInternalRoughBounds().expand(u.multiply(2))._containsPoint(n)) return null;
                var c, d = !(i.guides && !this._guide || i.selected && !this._selected || i.type && i.type !== e.hyphenate(this._class) || i["class"] && !(this instanceof i["class"])),
                    _ = this;
                if (d && (i.center || i.bounds) && this._parent) {
                    var f = this.getInternalBounds();
                    if (i.center && (c = r("center", "Center")), !c && i.bounds)
                        for (var g = ["TopLeft", "TopRight", "BottomLeft", "BottomRight", "LeftCenter", "TopCenter", "RightCenter", "BottomCenter"], v = 0; 8 > v && !c; v++) c = r("bounds", g[v])
                }
                var p = !c && this._children;
                if (p)
                    for (var m = this._getChildHitTestOptions(i), v = p.length - 1; v >= 0 && !c; v--) c = p[v]._hitTest(n, m);
            ...
            rotate: function(t) {
                return this.transform((new f).rotate(t, h.read(arguments, 1, {
                    readNull: !0
                }) || this.getPosition(!0)))
            }
            ...
            fitBounds: function(t, e) {
                ...
                var n = this.getBounds(),
                    ...
                    a = new d(new h, new l(n.width * s, n.height * s));
                ...
                if (this._visible && 0 !== this._opacity) {
                    ...
                    if (h.isInvertible()) {
                        ...
                        var u, l, c, d = this._blendMode,
                            ...
                            f = "normal" === d,
                            g = $.nativeModes[d],
                            v = f && 1 === _ || e.dontStart || e.clip || (g || f && 1 > _) && this._canComposite(),
                            p = e.pixelRatio || 1;
                        if (!v) {
                        ...
                        var y = n ? n.chain(o) : !this.getStrokeScaling(!0) && i(h),
                            w = !v && e.clipItem,
                            x = !y || w;
                        if (v ? (t.globalAlpha = _, g && (t.globalCompositeOperation = d)) : x && t.translate(-l.x, -l.y), x && (v ? o : i(h)).applyToContext(t), w && e.clipItem.draw(t, e.extend({
                                clip: !0
                            })), y) {
            ...
            _drawSelection: function(t, e, n, i, r) {
                if ((this._drawSelected || this._boundsSelected) && this._isUpdated(r)) {
                    ...
                    if (t.strokeStyle = t.fillStyle = s ? s.toCanvasStyle(t) : "#009dec", this._drawSelected && this._drawSelected(t, a, i), this._boundsSelected) {
                        var o = n / 2,
                            h = a._transformCorners(this.getInternalBounds());
                        t.beginPath();
        ...
        x = m.extend({
                ...
                if (r || s || a) {
                    ...
                    if (e.dontStart || t.beginPath(), o && l) t.arc(0, 0, u, 0, 2 * Math.PI, !0);
                        ...
                        var c = l ? u : u.width,
                            ...
                            f = _.width,
                            g = _.height;
                        if (o && "rectangle" === h && 0 === c && 0 === d) t.rect(-f / 2, -g / 2, f, g);
                        else {
                            var v = f / 2,
                                p = g / 2,
                                m = .44771525016920644,
                    ...
                    if (this.hasStroke()) {
                        ...
                        if ("rectangle" === a) {
                            ...
                            if (u) {
                                ...
                                var c = new d(this._size).setCenter(0, 0),
                                    _ = c.expand(h),
                                    f = c.expand(-h);
            ...
            statics: new function() {
                ...
                return {
                    ...
                    Rectangle: function() {
                        var e = d.readNamed(arguments, "rectangle"),
                            n = l.min(l.readNamed(arguments, "radius"), e.getSize(!0).divide(2));
                        return t("rectangle", e.getCenter(!0), e.getSize(!0), n, arguments)
                    },
                    Ellipse: function() {
                        var e = x._readEllipse(arguments),
                            n = e.radius;
                        return t("ellipse", e.center, n.multiply(2), n, arguments)
                    },
                    _readEllipse: function(t) {
                        var n, i;
                        if (e.hasNamed(t, "radius")) n = h.readNamed(t, "center"), i = l.readNamed(t, "radius");
                        else {
        ...
        b = m.extend({
            ...
            setSource: function(t) {
                ...
                var n, i = this,
                    r = this._crossOrigin;
                n = document.getElementById(t) || new Image, r && (n.crossOrigin = r), n.naturalWidth && n.naturalHeight ? setTimeout(e, 0) : (q.add(n, {
                    load: e
        ...
        I = e.extend({
            ...
            divide: function(t, e, n) {
                var i = this._getParameter(t, e),
                    ...
                    a = null;
                if (i >= r && s >= i) {
                    var o = I.subdivide(this.getValues(), i),
                        u = o[0],
                        l = o[1],
                        c = n || this.hasHandles(),
                        d = this._segment1,
                    ...
                    var g = u[6],
                        v = u[7],
                        p = new P(new h(g, v), c && new h(u[4] - g, u[5] - v), c && new h(l[2] - g, l[3] - v));
            ...
            statics: {
                ...
                getParameterOf: function(t, e) {
                    ...
                    if (null !== s) return s;
                    for (var a = [e.x, e.y], o = [], u = 2e-7, l = 0; 2 > l; l++)
                        for (var c = I.solveCubic(t, l, a[l], o, 0, 1), d = 0; c > d; d++)
                            if (s = o[d], e.isClose(I.getPoint(t, s), u)) return s;
            ...
            function i(t, e, n, i) {
                ...
                if (0 === n && (g > e || e > v)) {
                    ...
                    var m = 3 * (u - a),
                        ...
                        b = 3 * (d - l) - x,
                        C = f - o - x - b;
                    if (0 === n) r = ((w * e + y) * e + m) * e + a, s = ((C * e + b) * e + x) * e + o;
                    else {
            ...
            function t(t, e, n, i, r, s, a, o, h, u, l) {
                ...
                if (null == r && (r = I.getParameterOf(n, s)), null !== r && r >= (c ? _ : 0) && (d ? f : 1) >= r && (null == h && (h = I.getParameterOf(a, u)), null !== h && h >= (d ? _ : 0) && (c ? f : 1) >= h)) {
                    ...
                    var p = new z(i, r, s || I.getPoint(n, r), l),
                        m = new z(o, h, u || I.getPoint(a, h), l),
            ...
            function s(e, n, i, r, s, o) {
                ...
                for (var S = [], P = I.solveCubic(w, 1, 0, S, 0, 1), x = 0; P > x; x++) {
                    var M = S[x],
                        z = I.getPoint(u, M),
                        k = I.getParameterOf(l, z);
                    if (null !== k) {
                        var O = I.getPoint(l, k),
                            A = h ? k : M,
                            T = h ? M : k;
                ...
                statics: {
                    ...
                    _getSelfIntersection: function(t, e, n, i) {
                        var r = t[0],
                            ...
                            _ = t[7],
                            f = new g(r, s, d, _, !1),
                            v = f.getSide(new h(o, u), !0),
                            p = f.getSide(new h(l, c), !0);
                        if (v === p) {
                        ...
                        if (0 > P * P - 4 * M * z) {
                            var k, O = [],
                                A = a.solveCubic(y * y + b * b, 3 * (y * w + b * C), 2 * (w * w + C * C) + y * x + b * S, w * x + C * S, O, 0, 1);
                            if (A > 0) {
                    ...
                    getOverlaps: function(t, e) {
                        ...
                        if (2 !== v.length) v = null;
                            ...
                            var x = I.getPart(t, v[0][0], v[1][0]),
                                b = I.getPart(e, v[0][1], v[1][1]);
        ...
        z = e.extend({
            ...
            beans: !0,
            initialize: function ft(t, e, n, i, r) {
                if (e > .9999996) {
                    var s = t.getNext();
                    s && (e = 0, t = s)
                }
            ...
            getOffset: function() {
                ...
                if (null == t) {
                    ...
                    var e = this.getPath(),
                        n = this.getIndex();
                    if (e && null != n)
                        for (var i = e.getCurves(), r = 0; n > r; r++) t += i[r].getLength();
            ...
            equals: function(t, e) {
                ...
                if (!n && t instanceof z && this.getPath() === t.getPath() && this.getPoint().isClose(t.getPoint(), i)) {
                    var r = this.getCurve(),
                        s = t.getCurve(),
                        a = Math.abs,
                        o = a((r.isLast() && s.isFirst() ? -1 : r.getIndex()) + this.getParameter() - ((s.isLast() && r.isFirst() ? -1 : s.getIndex()) + t.getParameter()));
            ...
            isCrossing: function() {
                ...
                var a = this.getCurve(),
                    ...
                    l = Math.PI;
                if (!o || !u) return !1;
                var c = o.getTangentAt(s, !0).negate().getAngleInRadians(),
                    d = a.getTangentAt(r, !0).getAngleInRadians(),
                    _ = u.getTangentAt(s, !0).negate().getAngleInRadians(),
                    f = h.getTangentAt(r, !0).getAngleInRadians();
            ...
            function t(t, e, n) {
                ...
                for (var r = t.length, s = 0, a = r - 1; a >= s;) {
                    ...
                    var l = e.getPath(),
                        c = u.getPath(),
                        d = l === c ? e.getIndex() + e.getParameter() - (u.getIndex() + u.getParameter()) : l._id - c._id;
                    0 > d ? a = h - 1 : s = h + 1
                }
        ...
        k = m.extend({
            ...
            getIntersections: function(t, e, n, i) {
                var r = this === t || !t,
                    s = this._matrix.orNullIfIdentity(),
                    a = r ? s : (n || t._matrix).orNullIfIdentity();
        ...
        O = k.extend({
            ...
            _changed: function gt(e) {
                if (gt.base.call(this, e), 8 & e) {
                    var n = this._parent;
                    if (n && (n._currentPath = t), this._length = this._area = this._clockwise = this._monoCurves = t, 16 & e) this._version++;
            ...
            getPathData: function(t, e) {
                ...
                var i, r, a, o, h, u, l, c, d = this._segments,
                    _ = d.length,
                    f = new s(e),
                    g = Array(6),
                    v = !0,
            ...
            hasHandles: function() {
                for (var t = this._segments, e = 0, n = t.length; n > e; e++)
            ...
            toShape: function(t) {
                ...
                function i(t) {
                    ...
                    if (i.isOrthogonal(r)) {
                        var o = e._point,
                            h = n._point,
                            u = new g(o, i, !0).intersect(new g(h, r, !0), !0);
            ...
            _hitTestSelf: function(t, e) {
                ...
                function i(t, i, r) {
                    if (!e.selected || i.isSelected()) {
                        var s = t._point;
                        if (i !== s && (i = i.add(s)), n(i, w)) return new S(r, f, {
                            segment: t,
                            point: i
                        })
                    }
                ...
                var o, u, l, c, d, _, f = this,
                    ...
                    b = e.fill && g.hasFill(),
                    C = e.curves,
                    P = x ? g.getStrokeWidth() / 2 : b && e.tolerance > 0 || C ? 0 : null;
            ...
            function e(t, e, n) {
                function i(e) {
                    if (n) e._transformCoordinates(n, f, !1), r = f[0], s = f[1];
                    else {
                        var i = e._point;
                        r = i._x, s = i._y
                    }
            ...
            return {
                ...
                arcTo: function() {
                    var n, i, r, s, a, o = t(this),
                        ...
                        d = e.peek(arguments),
                        _ = e.pick(d, !0);
                    if ("boolean" == typeof _) var v = u.add(c).divide(2),
                        n = v.add(v.subtract(u).rotate(_ ? -90 : 90));
                    else if (e.remain(arguments) <= 2) n = c, c = h.read(arguments);
                    else {
                    ...
                    if (n) {
                        var T = new g(u.add(n).divide(2), n.subtract(u).rotate(90), !0),
                            N = new g(n.add(c).divide(2), c.subtract(n).rotate(90), !0),
                            L = new g(u, c),
                            E = L.getSide(n);
                    ...
                    for (var j = Math.abs(r), D = j >= 360 ? 4 : Math.ceil(j / 90), R = r / D, F = R * Math.PI / 360, q = 4 / 3 * Math.sin(F) / (1 + Math.cos(F)), V = [], H = 0; D >= H; H++) {
                        var w = c,
                            Z = null;
                        if (D > H && (Z = s.rotate(90).multiply(q), a ? (w = a._transformPoint(s), Z = a._transformPoint(s.add(Z)).subtract(w)) : w = i.add(s)), 0 === H) o.setHandleOut(Z);
                        else {
    ...
    O.inject({
        statics: new function() {
            function t(t, n, i) {
                var r = e.getNamed(i),
                    s = new O(r && r.insert === !1 && m.NO_INSERT);
            ...
            var i = .5522847498307936,
                r = [new P([-1, 0], [0, i], [0, -i]), new P([0, -1], [-i, 0], [i, 0]), new P([1, 0], [0, -i], [0, i]), new P([0, 1], [i, 0], [-i, 0])];
            return {
                Line: function() {
                ...
                Rectangle: function() {
                    var e, n = d.readNamed(arguments, "rectangle"),
                        r = l.readNamed(arguments, "radius", 0, {
                            readNull: !0
                        }),
                        s = n.getBottomLeft(!0),
                        a = n.getTopLeft(!0),
                    ...
                    if (!r || r.isZero()) e = [new P(s), new P(a), new P(o), new P(h)];
                    else {
    ...
    var A = k.extend({
        ...
        var n = {
            moveTo: function() {
                var e = t(this),
                    n = e && e.isEmpty() ? e : new O(m.NO_INSERT);
    ...
    k.inject(new function() {
        ...
        function u(t, e, n, i) {
            ...
            if (n) {
                ...
                for (var P, M, z = l - r, k = l + r, O = !1, w = 0, x = e.length; x > w; w++) {
                    var A = e[w],
                        b = A.values,
                        T = A.winding;
                    if (T && (1 === T && c >= b[1] && c <= b[7] || c >= b[7] && c <= b[1]) && 1 === I.solveCubic(b, 1, c, f, 0, 1)) {
                        ...
                        if (!(N > o && O && A.next !== e[w + 1] || s > N && M > o && A.previous === P)) {
                            var L = I.getPoint(b, N).x,
                                E = I.getTangent(b, N).y,
                                B = !1;
        ...
        function l(t, e, n, i, r) {
            ...
            for (var _ = 0; 3 > _; _++)
                for (var d = h * (_ + 1) / 4, f = 0, g = a.length; g > f; f++) {
                    var v = a[f],
                        p = v.length;
                    if (p >= d) {
                        (s > d || s > p - d) && (d = p / 2);
                ...
                if (0 !== I.getLength(e)) {
                    ...
                    if (I.isStraight(e)) t(e);
                        ...
                        var o = 3 * (i - r) - n + s,
                            ...
                            c = 1 - l,
                            d = [],
                            _ = a.solveQuadratic(o, h, u, d, l, c);
                        if (0 === _) t(e);
                        else {
                            d.sort();
                            var f = d[0],
        ...
        getInteriorPoint: function() {
            ...
            if (!this.contains(e)) {
                for (var n = this._getMonoCurves(), i = [], r = e.y, s = [], a = 0, o = n.length; o > a; a++) {
                    var h = n[a].values;
                    if ((1 === n[a].winding && r >= h[1] && r <= h[7] || r >= h[7] && r <= h[1]) && I.solveCubic(h, 1, r, i, 0, 1) > 0)
                        for (var u = i.length - 1; u >= 0; u--) s.push(I.getPoint(h, i[u]).x);
                    if (s.length > 1) break
                }
                e.x = (s[0] + s[1]) / 2
            }
        ...
        N = e.extend({
            ...
            fitCubic: function(e, n, i, r) {
                ...
                for (var h, u = this.chordLengthParameterize(e, n), l = Math.max(this.error, this.error * this.error), c = !0, d = 0; 4 >= d; d++) {
                    var _ = this.generateBezier(e, n, u, i, r),
                        f = this.findMaxError(e, n, _, u);
                    if (f.error < this.error && c) return this.addCurve(_), t;
                    if (h = f.index, f.error >= l) break;
                    c = this.reparameterize(e, n, u, _), l = f.error
                }
                var g = this.points[h - 1].subtract(this.points[h]),
                    v = this.points[h].subtract(this.points[h + 1]),
                    p = g.add(v).divide(2).normalize();
            ...
            generateBezier: function(t, e, n, i, r) {
                for (var s = 1e-12, a = this.points[t], o = this.points[e], h = [
                    ...
                    var d = n[l],
                        ...
                        y = i.normalize(v),
                        w = r.normalize(p),
                        x = this.points[t + l].subtract(a.multiply(g + v)).subtract(o.multiply(p + m));
        ...
        B = e.extend(new function() {
            ...
            return e.each(i, function(t, n) {
                ...
                initialize: function c(e) {
                    var n, s, a, h, u = Array.prototype.slice,
                        l = arguments,
                        d = 0;
                    ...
                    if ("string" === _ && e in i && (n = e, e = l[1], Array.isArray(e) ? (s = e, a = l[2]) : (this.__read && (d = 1), l = u.call(l, 1), _ = typeof e)), !s) {
                        ...
                        } else if ("string" === _) n = "rgb", s = t(e), 4 === s.length && (a = s[3], s.length--);
                        else if ("object" === _)
                            if (e.constructor === c) {
                                if (n = e._type, s = e._components.slice(), a = e._alpha, "gradient" === n)
                                    for (var g = 1, v = s.length; v > g; g++) {
                                        var p = s[g];
                                        p && (s[g] = p.clone())
                                    }
                            } else if (e.constructor === j) n = "gradient", h = l;
                        else {
        ...
        R = e.extend(new function() {
            ...
            return e.each(n, function(n, a) {
                ...
                s[d] = function(e) {
                    var n = this._owner,
                        i = n && n._children;
                    if (i && i.length > 0 && !(n instanceof A))
            ...
            getLeading: function wt() {
                var t = wt.base.call(this),
                    e = this.getFontSize();
    ...
    q.requestAnimationFrame = new function() {
        ...
        var e, n = F.getPrefixed(window, "requestAnimationFrame"),
            r = !1,
            s = [],
            a = !0;
        return q.add(window, {
    ...
    var V = e.extend(n, {
            ...
            function n() {
                if (!V._focused || !V._focused.isVisible())
                    for (var t = 0, e = V._views.length; e > t; t++) {
                        var n = V._views[t];
                        if (n && n.isVisible()) {
                            V._focused = a = n;
                            break
            ...
            return {
                ...
                _installEvent: function(t) {
                    ...
                    if (e)
                        for (var n in f) e[n] = (e[n] || 0) + (f[n][t] || 0)
                },
                _uninstallEvent: function(t) {
                    var e = this._eventCounters;
                    if (e)
                        for (var n in f) e[n] -= f[n][t] || 0
                },
                statics: {
                    updateFocus: n
                }
        ...
        H = V.extend({
            ...
            initialize: function(t, e) {
                ...
                if (this._context = e.getContext("2d"), this._eventCounters = {}, this._pixelRatio = 1, !/^off|false$/.test(i.getAttribute(e, "hidpi"))) {
                    var r = window.devicePixelRatio || 1,
                        s = F.getPrefixed(this._context, "backingStorePixelRatio") || 1;
            ...
            getPixelSize: function(t) {
                ...
                if (n && n.firefox) {
                    var i = this._element.parentNode,
        ...
        G = new function() {
            function t(i, s, u, l) {
                var c, d = u ? String.fromCharCode(u) : "",
                    _ = r[s],
                    f = _ || d.toLowerCase(),
                    g = i ? "keydown" : "keyup",
                    v = V._focused,
                    p = v && v.isVisible() && v._scope,
                    m = p && p.tool;
                if (h[f] = i, i ? o[s] = u : delete o[s], _ && (c = e.camelize(_)) in a) {
                    a[c] = i;
                    var y = paper.browser;
                    if ("command" === c && y && y.mac)
                        if (i) n = {};
                        else {
            ...
            _updateEvent: function(t, e, n, i, r, s, a) {
                if (!r) {
                    if (null != n || null != i) {
                        ...
                        if (o > u) return !1;
                        if (null != i && 0 != i)
                            if (u > i) e = this._point.add(h.normalize(i));
                            else if (a) return !1
                    }
    ...
    return new function() {
        ...
        function r(e, r) {
            for (var s = i(e._matrix), a = e._children, o = n("g", s), h = 0, u = a.length; u > h; h++) {
                ...
                if (c)
                    if (l.isClipMask()) {
                        var d = n("clipPath");
                        d.appendChild(c), p(l, d, "clip"), t(o, {
                            "clip-path": "url(#" + d.id + ")"
                        })
        ...
        function c(t, e) {
            var r = i(t._matrix, !0),
                ...
                h = o.getBounds();
            return a || (a = n("symbol", {
                viewBox: b.rectangle(h)
            }), a.appendChild(w(o, e)), p(s, a, "symbol")), r.href = "#" + a.id, r.x += h.x, r.y += h.y, r.width = b.number(h.width), r.height = b.number(h.height), r.overflow = "visible", n("use", r)
        }
        ...
        function a(t, e, n, i) {
            var r = t.childNodes,
                ...
                h = o._currentStyle,
                u = [];
            if (s || (a = C(a, t, i), o._currentStyle = a._style.clone()), i)
                for (var l = t.querySelectorAll("defs"), c = 0, d = l.length; d > c; c++) P(l[c], n, !1);
            for (var c = 0, d = r.length; d > c; c++) {
                var _, f = r[c];
        ...
        function C(n, i, r) {
            var s = {
                node: F.getStyles(i) || {},
                parent: !r && F.getStyles(i.parentNode) || {}
            };
        ...
        function P(t, n, i) {
            ...
            var h, u = s.nodeName.toLowerCase(),
                l = M[u],
                c = s.getAttribute && s.getAttribute("data-paper-data"),
                d = a.settings,
                _ = d.applyMatrix;
        ...
        var M = {
            ...
            I = e.set(e.each(K, function(t) {
                ...
                viewBox: function(t, e, n, i, a) {
                    var o = new d(s(e, "array")),
                        h = r(i, "width", "height", !0);
                    if (t instanceof y) {
                        var u = h ? o.getSize().divide(h) : 1,
                            l = (new f).translate(o.getPoint()).scale(u);
                        t.transform(l.inverted())
                    } else if (t instanceof p) {
                        h && o.setSize(h);
                        var c = "visible" != w(i, "overflow", a),
                            _ = t._definition;
